class Calendar {
    ...
    bindEvents() {
        ...
        document.getElementById('dropdown-icon').addEventListener('click', () => this.isCollapsed());
    ...
    bindEvents() {
        document.getElementById('dateText').addEventListener('click', () => this.handleHeaderClick())
        document.getElementById('dropdownIcon').addEventListener('click', () => this.isCollapsed());
        document.getElementById('calendarTitle').addEventListener('click', () => this.handleNavTitleClick());
        const arrows = document.querySelectorAll('.arrow-controls span');
        if (arrows.length >= 2) {
            arrows[0].addEventListener('click', () => this.navigate(-1)); 
    ...
    isCollapsed() {
        ...
        if (calendar.classList.contains('collapsed')) {
            ...
            // Đổi icon mũi tên thành hướng lên
            ...
            // Đổi icon mũi tên thành hướng xuống
            if (dropdownIcon.tagName === 'I') {
